...
- **Format:** Markdown (`.md`)
- **Location:** `/tasks/` (in the project folder)
...
4.  **Phase 1: Generate Parent Tasks:** Based on the PRD analysis and current state assessment, create the file and generate the main, high-level tasks required to implement the feature. Use your judgement on how many high-level tasks to use. **Each Parent Task must be an independant change that can be deployed.**
